...
test_that("Reading of output scalars works", {
  expect_identical(gdxio$rgdx(file.path(getwd(), "data/trnsport.gdx"), scalarsOutName), 
                   tibble('scalarSymbols$symnames' = 'f', 
