  ...
  properties: {
    ...
    main: {
      ...
      required: ['ErrorUnexpectedHdr', 'ErrorUnexpectedMsg', 'ErrorUnexpectedMsg2', 'ErrorUnexpectedMsg3', 'BtnCancel', 'BtnOk', 'BtnRemove', 'ErrorInvalidHdr',
        ...
        'ErrorInvalidPathHdr', 'ErrorInvalidPathMsg', 'ErrorInvalidPathMsgMac', 'ErrorInvalidPathMsg2', 'ErrorEngineTokenRefreshHdr', 'ErrorEngineTokenRefreshMsg',
        'OpenSettingsBtnYes', 'ErrorNewScenHdr', 'ErrorNewScenMsg', 'ErrorNewScenNoApp', 'ErrorMessage', 'SuccessUpdateHdr', 'SuccessUpdateMsg', 'ErrorUnexpectedWriteMsg',
        'DeleteMsg', 'DeleteDataMsg', 'ErrorInit', 'ErrorRInstallHdr', 'ErrorRInstallMsg', 'ErrorModelPathHdr', 'ErrorModelPathMsg', 'ErrorRNotFoundHdr', 'ErrorRNotFoundMsg',
    ...
    settings: {
      ...
      required: ['title', 'general-tab', 'paths-tab', 'env-tab', 'launchBrowser',
        ...
        'colorThemeOptionCustom', 'remoteExecReset', 'generalLogging', 'loggingReset', 'generalLoglife',
        'loglifeReset', 'pathMiroapp', 'pathMiroappSelect', 'resetPathMiroapp',
        'pathGams', 'pathGamsSelect', 'pathGamsReset', 'pathPython', 'pathPythonSelect',
        'pathPythonReset', 'pathLog', 'pathLogSelect',
        ...
        'dialogGamsPathMsg', 'dialogGamsPathLabel', 'dialogGamsPathBtn', 'dialogPythonPathHdr',
        'dialogPythonPathMsg', 'dialogPythonPathLabel', 'dialogPythonPathBtn', 'dialogRPathHdr',
        ...
        'engineUrlLabel', 'engineNsLabel', 'engineLoginMethodLabel', 'engineLoginMethodValidation',
        'engineLoginMethodValidationSuccess', 'engineLoginMethodUserPass', 'engineUsernameLabel',
        'enginePasswordLabel', 'engineJWTLabel', 'engineNsValidation', 'engineUsernameValidation',
        'enginePasswordValidation', 'engineJWTValidation'],
    },
  },
...
const en = {
  ...
  main: {
    ...
    ErrorEngineTokenRefreshMsg: 'The GAMS Engine token could not be updated. Would you like to open the "Preferences" window now to log in again?',
  ...
  settings: {
    ...
    dialogPythonPathHdr: 'Please select the path where you installed Python as well as GAMSPy.',
    dialogPythonPathMsg: 'Please select the path where you installed Python as well as GAMSPy.',
...
log file should be stored is invalid! Please enter only whole numbers!',
    ...
    engineNsValidationPerm: 'You don\'t have sufficient permissions to execute models in the namespace.',
...
const de = {
  ...
  main: {
    ...
    ErrorEngineTokenRefreshHdr: 'Probleme beim Aktualisieren des Engine-Tokens',
    ErrorEngineTokenRefreshMsg: 'Das GAMS-Engine-Token konnte nicht aktualisiert werden. Möchten Sie jetzt das Fenster "Einstellungen" öffnen, um sich erneut anzumelden?',
  ...
  settings: {
    ...
    dialogPythonPathHdr: 'Bitte wählen Sie das Verzeichnis aus, in dem Sie GAMS und GAMSPy installiert haben.',
    dialogPythonPathMsg: 'Bitte wählen Sie das Verzeichnis aus, in dem Sie GAMS und GAMSPy installiert haben.',
    ...
    engineJWTLabel: 'JWT',
    engineNsValidation: 'Der von Ihnen eingegebene Namensraum konnte nicht gefunden werden.',
    engineNsValidationPerm: 'Sie haben nicht genügend Berechtigungen, um Modelle im Namensraum auszuführen.',
...
const cn = {
  ...
  main: {
    ...
    ErrorEngineTokenRefreshMsg: '无法更新 GAMS Engine 令牌。 您想立即打开“设置”窗口再次登录吗？',
