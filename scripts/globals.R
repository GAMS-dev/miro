...
), c("R6", "2.5.0"), c("BH", "1.75.0-0"), c("magrittr", "2.0.1"
), c("rlang", "0.4.11"), c("later", "1.2.0"), c("promises", "1.2.0.1"
), c("httpuv", "1.6.1"), c("mime", "0.11"), "jsonlite", c("digest",
"0.6.27"), c("sourcetools", "0.1.7"), c("xtable", "1.8-4"), c("fastmap",
"1.1.0"), c("curl", "4.3.2"), c("V8", "3.4.2"), c("base64enc",
"0.1-3"), c("htmltools", "0.5.1.1"), c("withr", "2.4.2"), c("leaflet.providers",
...
"1.5.3"), c("png", "0.1-7"), c("RColorBrewer", "1.1-2"), c("lattice",
...
"1.1.1"), c("zeallot", "0.1.0"), c("crosstalk", "1.1.1"), "DT",
    ...
    "3.1.3"), c("generics", "0.1.0"), c("dplyr", "1.0.7"), c("sys",
    "3.4"), c("askpass", "1.1"), c("prettyunits", "1.1.1"), c("stringi",
    "1.7.3"), c("DBI", "1.1.1"), c("blob", "1.2.2"), c("hms",
    "1.1.0"), c("cpp11", "0.3.1"), c("tidyr", "1.1.3"), c("cachem",
    ...
    "1.0.1"), c("zoo", "1.8-9"), c("globals", "0.12.5"), c("listenv",
    ...
    "0.6.0"), c("xts", "0.12.1"), c("dygraphs", "1.1.1.6"), c("future",
...
if (identical(Sys.getenv("BUILD_DOCKER"), "true")) {
  ...
  }, logical(1L), USE.NAMES = FALSE)], list(c("RPostgres", "1.3.3")))
} else {
  if (identical(RLibPath, "")) {
