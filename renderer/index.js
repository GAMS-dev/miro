...
$(() => {
  ...
  function toggleEditMode() {
    if (isInEditMode) {
      ...
      $('.app-id-field').hide();
      $('#editIcon').removeClass('fa-check').addClass('fa-pen-to-square');
      isInEditMode = false;
    } else {
      ...
      $('#editIcon').removeClass('fa-pen-to-square').addClass('fa-check');
      isInEditMode = true;
    ...
    addAppWrapper.html(`<div class="app-box" id="expandedAddAppWrapper">
                          ...
                          <div style="height:200px;">
                             <div class="drag-drop-area app-window" id="newAppFiles">
                               <div class="drag-drop-area-text empty d-flex flex-column justify-content-center align-items-center h-100 position-relative">
                                 <div class="drag-drop-plus-icon">
  ...
  appsWrapper.on('dragleave', '.app-box', (e) => {
    e.preventDefault();
    e.stopPropagation();
    dragAddAppCounter -= 1;
  });
