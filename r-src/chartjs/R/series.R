...
#' @keywords internal
#' @export
cjsSeries.cjs_bar <- function(cjs, data, type = "bar", label = NULL, scale = NULL, fill = FALSE, fillOpacity = 0.7, ...){
  n <- length(cjs$x$data$datasets)
  colours <- cjs %>% cjs_get_colours(n, fill = fill, fillOpacity = fillOpacity)
