...
/*!***********************!*\
  !*** ./srcjs/miro.js ***!
  \***********************/
/*! exports provided: showSpinnerIcon, changeTab, slideToggleEl, confirmModalShow, removeAttachment, downloadAttachment, changeDDButtonEvent, showJobsDialog, renderMathJax, validateSname, validateHcubeHash, jumpToLogMark */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var arrayTypes = {
  ...
  chart_ydatascatter: function chart_ydatascatter() {
    var elements = {
      ...
      marker_symbol: ['select', lang.addScatterDataEl.symbol, ['circle', 'circle-open', 'square', 'square-open', 'diamond', 'diamond-open', 'cross', 'cross-open', 'x', 'x-open', 'triangle-up', 'triangle-up-open', 'triangle-down', 'triangle-down-open', 'pentagon', 'pentagon-open', 'hexagon', 'hexagon-open', 'octagon', 'octagon-open', 'star', 'star-open', 'hexagram', 'hexagram-open', 'asterisk', 'asterisk-open', 'hash', 'hash-open', 'line-ew', 'line-ew-open', 'line-ns', 'line-ns-open'], lang.addScatterDataEl.symbolChoices],
