...
function () {
  ...
  _createClass(InputArray, [{
    ...
    value: function createEl() {
      ...
      $.each(this.elements, function (k, v) {
        ...
        switch (v[0]) {
          case 'select':
            if (idx === 0) {
              if (_this.options.elRequired === true) {
                ...
                if (_this.resetDefault() || typeof v[4] === 'undefined') {
            ...
            arrayContent += InputArray.createSelectInput(k, elID, v[1], choices, aliases, selected, v[5], v[6]);
            break;

          case 'selectDep':
            var _v5 = _slicedToArray(v, 4);

            var _v5$ = _slicedToArray(_v5[3], 1);

            selected = _v5$[0];

            if (v[5] !== undefined) {
              var _v6 = _slicedToArray(v, 6);
          ...
          case 'text':
            ...
            if (idx === 0 && _this.options.elRequired === false && !(_this.options.noEventOnDefault === true && value)) {
              // tell R that new element was addded to array: (ID)
      ...
      arrayContent += "".concat(!this.options.elRequired || this.options.uniqueItems === true || elID > 1 ? "<button type=\"button\" onclick=\"Miro.removeArrayEl('".concat(this.arrayID, "','").concat(elID, "')\" class=\"btn btn-default bt-icon\"><i class=\"far fa-minus-square\"></i></button>\n") : '', "<hr></div>");
    ...
    value: function removeArrayEl(elID) {
      ...
      if (arrayLabel.length === 0) {
        console.error("Could not find identifier for array element: ".concat(this.arrayID, " (label ID: ").concat(this.arrayID).concat(elID, ")."));
      }
      ...
      $.each(elements, function (k, v) {
        if (v[0] === 'select' || v[0] === 'selectDep') {
          if (!notFirstIdx && idx === 0) {
            ...
            var selectizeOptions = $("#".concat(k + htmlID)).parent().find("script[data-for=\"".concat(k + htmlID, "\"]"));
            var addOptions = selectizeOptions.length ? JSON.parse(selectizeOptions.text()) : {};
            $("#".concat(k).concat(htmlID)).selectize($.extend({
              onChange: function onChange(value) {
          ...
          if (v[0] === 'selectDep') {
            ...
            var _v10 = _slicedToArray(v, 2);

            altElements[k] = _v10[1];
          ...
          if (!notFirstIdx && idx === 0) {
            $("#".concat(k + htmlID)).on('change', function () {
          ...
          $("#".concat(k + htmlID)).on('change', $.debounce(250, function () {
            Shiny.setInputValue(rAddID, [elID, $(this).val(), k, 'change'], {
              priority: 'event'
            });
          }));
    ...
    value: function createSelectInput(arrayID, elID, label, choices) {
      ...
      var create = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : false;
      var id = arrayID + elID;
      ...
      return "<div class=\"config-array-err\" id=\"".concat(id, "_err\" style=\"display:none;\"></div><div class=\"form-group\">\n<label class=\"control-label\" for=\"").concat(id, "\">").concat(label, "</label>\n<div><select id=\"").concat(id, "\"").concat(multiple === true ? ' multiple="multiple"' : '', ">").concat(optionsHTML, "</select>").concat(create === true ? "<script type=\"application/json\" data-for=\"".concat(id, "\">{\"create\":true,\"persist\":false,\"openOnFocus\":false}</script>") : '', "\n</div>\n</div>");
    }
  }, {
    key: "createTextInput",
...
function () {
  ...
  _createClass(InputArrayFactory, [{
    ...
    key: "destroy",
    value: function destroy(arrayID) {
...
/*!***********************!*\
  !*** ./srcjs/miro.js ***!
  \***********************/
/*! exports provided: showSpinnerIcon, changeTab, slideToggleEl, confirmModalShow, removeAttachment, downloadAttachment, changeDDButtonEvent, showJobsDialog, validateSname, validateHcubeHash, jumpToLogMark */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function jumpToLogMark(id) {
  var el;
  return regeneratorRuntime.async(function jumpToLogMark$(_context) {
    while (1) {
...
$(document).ready(function () {
  $('#toolCategories').on('click', '.category-btn', function () {
    ...
    var catBody = $(".cat-body-".concat(catId));
  ...
  Shiny.addCustomMessageHandler('gms-scriptExecuted', function (data) {
    var scriptOutputContainer;
    ...
    if (data.hcube === true) {
      ...
      scriptOutputContainer = $("#scriptOutput_".concat(data.id, " .script-output"));
      Shiny.setInputValue('outputGenerated', 1, {
        priority: 'event'
      });
      $("#scriptOutput_".concat(data.id, " .script-spinner")).hide();
    } else {
      scriptOutputContainer = $("#scenScript_".concat(data.sid, "_").concat(data.id));
    }

    var scriptOutputContainerIframe = scriptOutputContainer[0].contentWindow.document;
    scriptOutputContainerIframe.open();
    scriptOutputContainerIframe.write(data.isError === true ? "<div style='margin:5px;color:#F39619;font-weight:bold;font-size:15pt;text-align:center;'>".concat(data.data, "</div>") : data.data);
...
/*!*****************************!*\
  !*** ./srcjs/miro_admin.js ***!
  \*****************************/
/*! exports provided: confirmModalShow, slideToggleEl, removeArrayEl, updateArrayEl, toggleDepContainer, mdToHTML, mdSave, addArrayDataEl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mdToHTML", function() { return mdToHTML; });
...
var arrayTypes = {
  ...
  symbol_links: function symbol_links(defaults) {
    var source;
    var target;
    ...
    var scalarOutputSym = outputSymbols.map(function (sym) {
      return ['_scalars_out', '_scalarsve_out'].find(function (sSym) {
        return sym === sSym;
      });
    });
    var scalarInputSym = inputSymbols.map(function (sym) {
      return ['_scalars', '_scalarsve'].find(function (sSym) {
        return sym === sSym;
      });
    });
    var elements = {
      symbol_links: ['select', lang.addSymlink.source, outputSymbols.filter(function (sym, id) {
        return scalarOutputSym[id] === undefined;
      }), outputSymbolsAliases.filter(function (sym, id) {
        return scalarOutputSym[id] === undefined;
      }), source],
      symlink_target: ['select', lang.addSymlink.target, inputSymbols.filter(function (sym, id) {
        return scalarInputSym[id] === undefined;
      }), inputSymbolsAliases.filter(function (sym, id) {
        return scalarInputSym[id] === undefined;
      }), target]
    };
    return [elements, {
  ...
  scripts_base: function scripts_base(defaults) {
    var id;
    var tabTitle;
    var command;
    var args;
    ...
    return [elements, {
      elRequired: false,
      myopicDefaults: true,
      noEventOnDefault: true
    }, 'script'];
  },
  scripts_hcube: function scripts_hcube(defaults) {
    var id;
    var title;
    var command;
    var args;
  ...
  chart_piedata: function chart_piedata() {
    var elements = {
  ...
  chart_ydatascatter: function chart_ydatascatter() {
    var elements = {
      ...
      marker_symbol: ['select', lang.addScatterDataEl.symbol, ['_', 'circle', 'circle-open', 'square', 'square-open', 'diamond', 'diamond-open', 'cross', 'cross-open', 'x', 'x-open', 'triangle-up', 'triangle-up-open', 'triangle-down', 'triangle-down-open', 'pentagon', 'pentagon-open', 'hexagon', 'hexagon-open', 'octagon', 'octagon-open', 'star', 'star-open', 'hexagram', 'hexagram-open', 'asterisk', 'asterisk-open', 'hash', 'hash-open', 'line-ew', 'line-ew-open', 'line-ns', 'line-ns-open'], lang.addScatterDataEl.symbolChoices],
  ...
  chart_ydatabubble: function chart_ydatabubble() {
    var elements = {
      ...
      marker_symbol: ['select', lang.addBubbleDataEl.symbol, ['_', 'circle', 'circle-open', 'square', 'square-open', 'diamond', 'diamond-open', 'cross', 'cross-open', 'x', 'x-open', 'triangle-up', 'triangle-up-open', 'triangle-down', 'triangle-down-open', 'pentagon', 'pentagon-open', 'hexagon', 'hexagon-open', 'octagon', 'octagon-open', 'star', 'star-open', 'hexagram', 'hexagram-open', 'asterisk', 'asterisk-open', 'hash', 'hash-open', 'line-ew', 'line-ew-open', 'line-ns', 'line-ns-open'], lang.addScatterDataEl.symbolChoices],
...
function mdToHTML(mdContent, destId) {
  $(destId).html(converter.makeHtml(mdContent));
}
function mdSave(mdContentId) {
...
function addArrayDataElWrapper(arrayID, defaults, symbol) {
  var cnt = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
  var arrayWrapper;

  if (symbol) {
    arrayWrapper = $("#".concat(arrayID, "_wrapper[data-symbol=\"").concat(symbol, "\"]"));
  } else {
    arrayWrapper = $("#".concat(arrayID, "_wrapper"));
  }
...
$(document).ready(function () {
  ...
  Shiny.addCustomMessageHandler('gms-destroyArray', function (arrayID) {
    if (arrayID) {
...
/***/ 1:
/*!**************************************************!*\
  !*** multi babel-polyfill ./srcjs/miro_admin.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./srcjs/miro_admin.js */"./srcjs/miro_admin.js");
