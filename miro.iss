...
#define MyAppVersion="MIRO 0.4 BETA";
#define MyDirVersion="miro04";
#define UnInstInfo="{app}\.uninstinfo.ini"

[Setup]
ArchitecturesAllowed=x64
ArchitecturesInstallIn64BitMode=x64
;AppName=GAMS {#MyAppVersion}
AppName=GAMS
AppVerName=GAMS win{code:BitnessToStr} {#MyAppVersion}
...
VersionInfoDescription=GAMS {#MyAppVersion} installer
AlwaysUsePersonalGroup=no
DiskSpanning=false
OutputDir=output
SetupIconFile=gams.ico
...
var
   Link: string;
begin
Link := ExpandConstant('{userdesktop}\GAMS win') + BitnessToStr('') + ExpandConstant(' {#MyAppVersion}.lnk');
...
var
   Link: string;
begin
Link := ExpandConstant('{userdesktop}\GAMS Studio win') + BitnessToStr('') + ExpandConstant(' {#MyAppVersion}.lnk');
CreateShellLink(Link, '',
