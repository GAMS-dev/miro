...
miroPivotOutput <- function(id, height = NULL, options = NULL, path = NULL){
  ...
  tags$div(id = ns("container"),
           ...
           # fluidRow(style = "margin:0;",
           #          column(width = 2L,style="min-width:140px",
           #                 tagList(
           #                   tags$div(class="dropdown",
           #                            tags$button(class="btn btn-default dropdown-toggle btn-dropdown",
           #                                        type = "button", id = ns("toggleViewButtonPresentation"),
           #                                        onclick = "Miro.resetDropdownFilter(this)",
           #                                        `data-toggle`="dropdown", `aria-haspopup`="true",
           #                                        `aria-expanded` = "false", style = "width:100%;",
           #                                        lang$renderers$miroPivot$btLoadView, tags$span(
           #                                          class = "caret btn-dropdown-caret")),
           #                            tags$ul(id = ns("savedViewsDDPresentation"), class = "dropdown-menu btn-dropdown-menu view-dropdown-wrapper",
           #                                    `aria-labelledby` = ns("toggleViewButton"),
           #                            ))
           # 
           #                 ),
           ...
           #                        tags$i(class = "fa fa-file-image"),
           #                        title = lang$renderers$miroPivot$btDownloadPng)
           #                 # actionButton(ns("togglePivotControls"), label = "Pivot Controls", icon = icon("table"), 
           #                 #              title = "Toggle Pivot Controls",
           #                 #              class="btn-custom", width = "auto")
           #          )
           # ),
           fluidRow(id = ns("dataView"), class = "data-section", style = "display:none;",
                    fluidRow(style = "margin:0;display:flex;", 
                      column(width = 4L, style = "padding-right: 0px;",
                             tags$ul(id = ns("rows"), class = "drop-index-list-presentation",
                                     ...
                                     tags$li(class = "list-presentation",
                                             fluidRow(class="row-presentation",
                                                      column(width = 4L,class="column-presentation",
                                                             tags$div(class = "drop-index-item-presentation", "ASDASD")),
                                                      column(width = 8L, class="column-presentation",
                                                             tags$div(class = "uel-item-presentation", 
                                                                      "asd"),
                                                             tags$div(class = "uel-item-presentation", 
                                                                      "def"),
                                                             tags$div(class = "uel-item-presentation", 
                                     ...
                                     tags$li(class = "list-presentation",
                                             fluidRow(class="row-presentation",
                                                      column(width = 4L,class="column-presentation",
                                                             tags$div(class = "drop-index-item-presentation", "aghtjrtj")),
                                                      column(width = 8L, class="column-presentation",
                                                             tags$div(class = "uel-item-presentation", 
                                                                      "jytkl"),
                                                             tags$div(class = "uel-item-presentation", 
                                     ...
                                     tags$li(class = "list-presentation",
                                             fluidRow(class="row-presentation",
                                                      column(width = 4L,class="column-presentation",
                                                             tags$div(class = "drop-index-item-presentation", "nofilter")),
                                                      column(width = 8L)
                                             )),
                                     tags$li(class = "list-presentation",
                                             fluidRow(class="row-presentation",
                      ...
                      column(width = 4L, style = "padding-right: 0px;",
                             tags$ul(id = ns("cols"), class = "drop-index-list-presentation",
                                     tags$li(class = "list-presentation",
                                             fluidRow(class="row-presentation",
                                                      column(width = 4L,class="column-presentation",
                                                             tags$div(class = "data-section-header", 
                      ...
                      column(width = 4L, style = "padding-right: 0px;",
                             tags$ul(id = ns("agg"), class = "drop-index-list-presentation",
                                     tags$li(class = "list-presentation",
                                             fluidRow(class="row-presentation",
                                                      column(width = 4L,class="column-presentation",
                                                             tags$div(class = "data-section-header", 
