...
ioConfig <<- list(modelOut = list("_scalars_out" = list(symnames = c("cowf","explimitgr","big","pawat","pafod","tolcnl","tolpr","tolnwfp","betaf"),
                  ...
                  modelInRaw = list("_scalars" = list(symnames = c("baseyear","repco","gr","growthq","drc","the1","lstd","trcap","twcap","twefac", "labfac"),
                                                      symtext = c("","","","","","","","","","", ""),
                                    ...
                                    modedistanceset = list(symtype = "set", colTypes = "cccc",
                                                           headers = list(uni1 = list(), uni2 = list(), uni3 = list(),
                                                                          text = list())),
                                    modedistancesetnodata = list(symtype = "set", colTypes = "cccc",
                                                                 headers = list(uni1 = list(), uni2 = list(), uni3 = list(),
                                                                                text = list())),
                                    modedistancesetsparse = list(symtype = "set", colTypes = "cccc",
                                                                 headers = list(uni1 = list(), uni2 = list(), uni3 = list(),
                                                                                text = list())),
...
test_that("Reading parameters works", {
  expect_identical(xlsio$read("../data/exampleData.xlsx", "distance", indexRange = "index!A1", forceInit = TRUE),
                   tibble(uni1 = c("brussels","brussels","san francisco","san francisco","san francisco","boston","boston","boston"),
                          uni2 = c("cleveland","chicago","cleveland","chicago","dallas","cleveland","chicago","dallas"),
                          value = c(5000,6000,2200,2000,1800,700,900,1500)))
  expect_identical(xlsio$read("../data/exampleData.xlsx", "modedistance", indexRange = "index!A1"),
                   tibble(uni1 = c("ship","ship","truck","truck","rail","rail","barge","barge"),
...
test_that("Reading tables works", {
  expect_error(xlsio$read("../data/exampleData.xlsx", "distance3", indexRange = "index!A1", forceInit = TRUE),
               class = "error_data")
  expect_identical(xlsio$read("../data/exampleData.xlsx", "distance3a"),
                   tibble(uni = c("brussels", "san francisco", "boston"),
                          dallas = c(0,1800,1500),
                          chicago = c(6000,2000,900),
                          cleveland = c(5000,2200,700)))
  expect_identical(xlsio$read("../data/exampleData.xlsx", "distance4"),
                   tibble(uni1 = c("ship","truck","rail","barge"),
                          uni2 = c("brussels","san francisco","san francisco","san francisco"),
...
test_that("Reading sets works", {
  expect_identical(xlsio$read("../data/exampleData.xlsx", "i10", indexRange = "index", forceInit = TRUE),
  ...
  expect_identical(xlsio$read("../data/exampleData.xlsx", "i2"),
                   tibble(uni = c("boats","watercraft"),
                          text = c("","")))
  expect_identical(xlsio$read("../data/exampleData.xlsx", "i3"),
                   tibble(uni = c("new york",	"chicago",	"boston"),
                          text = c("city1","city2", "city3")))
  expect_identical(xlsio$read("../data/exampleData.xlsx", "i4"),
                   tibble(uni = c("new york",	"chicago",	"boston", "san francisco", "dallas", "houston"),
                          text = c("","","","","","")))
  expect_identical(xlsio$read("../data/exampleData.xlsx", "i4a"),
                   tibble(uni = c("new york",	"chicago",	"boston", "san francisco", "dallas"),
                          text = c("","","","","")))
  expect_identical(xlsio$read("../data/exampleData.xlsx", "modedistanceset", indexRange = "index", forceInit = TRUE),
                   tibble(uni1 = c("ship","ship","truck","truck","rail","rail","barge","barge"),
                          uni2 = c("brussels","brussels","san francisco","san francisco","san francisco","san francisco","san francisco","san francisco"),
                          uni3 = c("cleveland","chicago","cleveland","chicago","cleveland","chicago","cleveland","chicago"),
                          text = c("","","","","","","","")))
  expect_identical(xlsio$read("../data/exampleData.xlsx", "modedistancesetnodata", indexRange = "index"),
                   tibble(uni1 = c("ship","ship","ship","ship","truck","truck","truck","truck","rail","rail","rail","rail","barge","barge","barge","barge"),
                          ...
                          text = c("","","","","","","","","","","","","","","","")))
  expect_identical(xlsio$read("../data/exampleData.xlsx", "modedistancesetdense", indexRange = "index"),
                   tibble(uni1 = c("ship","ship","ship","ship","truck","truck","truck","truck","rail","rail","rail","rail","barge","barge","barge","barge"),
                          uni2 = c("brussels","brussels","san francisco","san francisco","brussels","brussels","san francisco","san francisco","brussels","brussels","san francisco","san francisco","brussels","brussels","san francisco","san francisco"),
                          uni3 = c("cleveland","chicago","cleveland","chicago","cleveland","chicago","cleveland","chicago","cleveland","chicago","cleveland","chicago","cleveland","chicago","cleveland","chicago"),
                          text = c("5000", "6000", "0", "0", "0", "0", "2200", "2000", "0", "0",
  ...
  expect_identical(xlsio$read("../data/exampleData.xlsx", "i11"),
                   tibble(uni1 = c("ship","truck","rail","barge"),
                          uni2 = c("brussels","brussels","san francisco","san francisco"),
                          uni3 = c("cleveland","chicago","cleveland","chicago"),
                          text = c("text 1","","text 2","no")))
  expect_identical(xlsio$read("../data/exampleData.xlsx", "i11dense"),
                   tibble(uni1 = c("ship","truck","rail","barge"),
                          uni2 = c("brussels","brussels","san francisco","san francisco"),
                          uni3 = c("cleveland","chicago","cleveland","chicago"),
                          text = c("text 1","","text 2","no")))
  expect_identical(xlsio$read("../data/exampleData.xlsx", "i11sparse"),
                   tibble(uni1 = c("ship","rail","barge"),
                          uni2 = c("brussels","san francisco","san francisco"),
                          uni3 = c("cleveland","cleveland","chicago"),
                          text = c("text 1","text 2","no")))
  expect_identical(xlsio$read("../data/exampleData.xlsx", "i11yn"),
                   tibble(uni1 = c("ship","rail"),
                          uni2 = c("brussels","san francisco"),
                          uni3 = c("cleveland","cleveland"),
                          text = c("","")))
  expect_identical(xlsio$read("../data/exampleData.xlsx", "i11nodata"),
                   tibble(uni1 = c("ship","truck","rail","barge"),
                          uni2 = c("brussels","brussels","san francisco","san francisco"),
                          uni3 = c("cleveland","chicago","cleveland","chicago"),
                          text = c("","","","")))
...
test_that("Reading variables/equations works", {
  expect_identical(xlsio$read("../data/exampleData.xlsx", "var1", indexRange = "vareqIndex", forceInit = TRUE),
  ...
  expect_identical(xlsio$read("../data/exampleData.xlsx", "_scalarsve_out"),
                   tibble(scalar = c("z"),
