...
Sys.setenv(MIRO_MODEL_PATH = file.path(testDir, "model", "transport_large",
                                       "transport.gms"))
Sys.setenv(MIRO_MODE="base")
pr <- PerformanceReporter$new()
pr$measure("startup",
           test_that("MIRO app transport_large starts",
                     expect_pass(testApp(file.path(testDir, ".."), "startup_performance_test",
                                         compareImages = FALSE))))
pr$publish()
