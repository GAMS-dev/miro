...
test_that("Generating hashes works", {
  hcubeBuilder <- HcubeBuilder$new(
    list(
      price = "--HCUBE_STATIC_price= 52d53711271c55d29fa6e21806171679",
  ...
  expect_identical(
    hcubeBuilder$generateScenHashes(),
    expectedHashes
  )
  hcubeBuilder$setDataHashes(
    list(
      price = "--HCUBE_STATIC_price= 52d53711271c55d29fa6e21806171679",
      maptest = "--HCUBE_STATIC_maptest= 19e47bfcc0e7d456f945ffb04fe5dba0",
      `__xattach_a.csv` = "--HCUBE_STATIC_a.csv= 19e47bfcc0e7d456f945ffb04fe5dba0",
  ...
  expect_identical(
    hcubeBuilder$generateScenHashes(),
    c(
      "191f29a7a6a62e21d783bc9500946bc9468ba46c6d986b6dceaee838e77edb52",
...
test_that("Subsetting scenario hashes works", {
  ...
  expect_identical(dplyr::select(
    tidyr::pivot_wider(scalars, names_from = "scalar", values_from = "value"),
    solver
  )[[1]], c("CBC", "CBC", "CONOPT", "CONOPT", "CONOPT"))
  expect_identical(dplyr::select(
    tidyr::pivot_wider(scalars, names_from = "scalar", values_from = "value"),
    maxstock
  )[[1]], c("1", "5", "1", "3", "12"))
...
test_that("Pushing cl args works", {
  ...
  # scrambling order of cl args/attachments should not change hashes
  expect_identical(hcubeBuilder$generateScenHashes(), c(
    "ae3825e459c5529a38f87ea3e3f99015ab2615e30dfde62c896f6669bee2d556",
