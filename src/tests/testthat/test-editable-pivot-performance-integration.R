...
test_that("Editing large data in table view works", {
  testServer(renderMiroPivot, {
    ...
    pr$measure("tableEditAddRow",
               session$setInputs(newRow_1 = "BAU_upd", newRow_2 = "-", newRow_3 = "-", newRow_4 = "-",
