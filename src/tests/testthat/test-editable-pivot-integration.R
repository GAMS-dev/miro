...
test_that("Editing in list view works", {
  testServer(renderMiroPivot, {
    ...
    expect_identical(convert_to_df(dataToRender()),
                     data.frame(a = c("a1", "a2", "a2", "a2", "a3", "a3", "a4", "a4", "a5", "a5"),
    ...
    session$setInputs(newRow_1 = "a4", newRow_2 = "b9", newRow_3 = "c9", newRow_4 = "d9",
                      newRow_5 = "e2", newRow_6 = "f11", newRow_7 = 1.5, btAddRowConfirm = 1L)
    expect_identical(convert_to_df(dataToRender()),
                     data.frame(a = c("a1", "a2", "a2", "a2", "a3", "a3", "a4", "a4", "a4", "a5", "a5"),
    ...
    expect_identical(convert_to_df(dataToRender()),
                     data.frame(a = c("a1", "a2", "a2", "a3", "a3", "a4", "a4", "a4", "a5"),
    ...
    expect_identical(convert_to_df(session$returned()),
                     data.frame(a = c("a2", "a3", "a4", "a1", "a2", "a3", "a4", "a5", "a4"),
...
test_that("Editing with reordered columns works", {
  testServer(renderMiroPivot, {
    session$setInputs(rowIndexList = c(letters[5:6], letters[1:4]), colIndexList = character(),
                      filterIndexList = character(), aggregationIndexList = character(),
                      aggregationFunction = "sum")
    expect_identical(convert_to_df(dataToRender()),
                     data.frame(e = c("e10", "e10", "e10", "e10", "e10", "e2", "e2", "e2", "e2", "e2"),
    ...
    expect_identical(convert_to_df(dataToRender()),
                     data.frame(e = c("e10", "e10", "e10", "e10",    "e2","e2", "e2", "e2", "e2", "e2"),
                                f = c("f10", "f10", "f10", "f10",    "f10","f10", "f10", "f10", "f10", "f10"),
    ...
    # clicking the add row button should not throw an error
    session$setInputs(btAddRow = 1L)
    session$setInputs(newRow_1 = "e3", newRow_2 = "f9", newRow_3 = "a1", newRow_4 = "b2",
                      newRow_5 = "c3", newRow_6 = "d4", newRow_7 = 1.5, btAddRowConfirm = 1L)
    expect_identical(convert_to_df(dataToRender()),
                     data.frame(e = c("e10", "e10", "e10", "e10",    "e2","e2", "e2", "e2", "e2", "e2", "e3"),
    ...
    session$setInputs(pivotTable_rows_selected = c(2, 11), btRemoveRows = 2L)
    expect_identical(convert_to_df(dataToRender()),
                     data.frame(e = c("e10", "e10", "e10", "e2", "e2", "e2", "e2", "e2", "e2"),
...
test_that("Editing with active filters works", {
  testServer(renderMiroPivot, {
    session$setInputs(rowIndexList = letters[2:6], colIndexList = character(),
    ...
    expect_identical(convert_to_df(dataToRender()),
                     data.frame(b = c("b2", "b7"),
                                ...
                                f = c("f10", "f9"),
                                value = c(2L, 2L)))
    session$setInputs(rowIndexList = c("b", "c", "d", "f"),
    ...
    # clicking the add row button should not throw an error
    session$setInputs(btAddRow = 1L)
    session$setInputs(newRow_1 = "b2", newRow_2 = "c2", newRow_3 = "d2", newRow_4 = "f10",
    ...
    expect_identical(convert_to_df(dataToRender()),
                     data.frame(b = c("b2"),
                                ...
                                value = c(1.5)))
    expect_identical(convert_to_df(session$returned()),
                     data.frame(a = c("a1", "a3", "a4", "a5", "a1", "a2", "a3", "a4", "a5", "a2"),
...
test_that("Editing with pivoted columns works", {
  testServer(renderMiroPivot, {
    session$setInputs(rowIndexList = c("b", "e", "f"), colIndexList = c("c", "d"),
                      filterIndexList = "a", filter_a = "a2", aggregationIndexList = character(),
                      aggregationFunction = "sum")
    expect_identical(convert_to_df(dataToRender()),
                     data.frame(b = c("b2", "b7"),
    ...
    session$setInputs(newRow_1 = "b1", newRow_2 = "e2", newRow_3 = "f10",
    ...
    expect_identical(convert_to_df(dataToRender()),
                     data.frame(b = c("b1", "b6"),
                                ...
                                c6.d6 = c(1.2, 6)))
    expect_identical(convert_to_df(session$returned()),
                     data.frame(a = c("a1", "a3", "a4", "a5", "a1", "a3", "a4", "a5", "a1"),
  ...
  testServer(renderMiroPivot, {
    ...
    expect_identical(convert_to_df(dataToRender()),
                     data.frame(b = character(),
                                ...
                                value = integer()))
    session$setInputs(filter_a = "a1", btAddRow = 1L)
    session$setInputs(newRow_1 = "a1", newRow_2 = "b1", newRow_3 = "c1",
