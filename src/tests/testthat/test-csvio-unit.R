...
test_that("Reading CSV file works", {
  ...
  expect_identical(csvio$read("../data/csvtest-3.sv", "distance4", colsToRead = c("header 2", "header 1", "Value 2", "Value 1")),
                   tibble(uni1 = paste0("i", 1:7),
                          uni2 = paste0("j", 1:7),
                          chicago = as.numeric(1:7),
                          clevelaND = c(12.34,13.470,16.471,11,13.477,7,13.4791)))
  expect_identical(csvio$read("../data/csvtest-3.sv", "distance4", colsToRead = c("header 2", "header 1", "-", "Value 2")),
                   tibble(uni1 = paste0("i", 1:7),
                          uni2 = paste0("j", 1:7),
