...
app$snapshotInit("valuebox_new_config_test")
Sys.sleep(2)
...
expect_true(app$waitFor("$('div[data-value=\"outputTabset_1\"] .small-box.bg-yellow h3')[0].innerText==='951.1662'", timeout = 50))
expect_true(app$waitFor("$('div[data-value=\"outputTabset_1\"] .small-box.bg-yellow p')[0].innerText==='asd'", timeout = 50))
expect_true(app$waitFor("$('div[data-value=\"outputTabset_1\"] .small-box.bg-red h3')[0].innerText==='11.9'", timeout = 50))
expect_true(app$waitFor("$('div[data-value=\"outputTabset_1\"] .small-box.bg-red p')[0].innerText===''", timeout = 50))
expect_true(app$waitFor("$('div[data-value=\"outputTabset_1\"] .small-box.bg-aqua h3')[0].innerText==='2016-01-04'", timeout = 50))
expect_true(app$waitFor("$('div[data-value=\"outputTabset_1\"] .small-box.bg-aqua p')[0].innerText==='first date of training period'", timeout = 50))
