...
expect_true(app$get_js("$('div[data-value=\"outputTabset_1\"] .row')[0].childElementCount===2", timeout = 50))
expect_true(app$get_js("$('div[data-value=\"outputTabset_1\"] .row')[1].childElementCount===1", timeout = 50))
