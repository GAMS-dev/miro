...
Sys.sleep(1)
expect_true(app$get_js("HTMLWidgets.getInstance(document.getElementById('in_1')).hot.setDataAtCell(0,1,'GAMS');true;", timeout = 50L))
expect_true(app$get_js("HTMLWidgets.getInstance(document.getElementById('in_1')).hot.setDataAtCell(0,2,6);true;", timeout = 50L))
expect_true(app$get_js("HTMLWidgets.getInstance(document.getElementById('in_1')).hot.setDataAtCell(1,2,7);true;", timeout = 50L))
app$set_inputs(inputTabset = "inputTabset_2")
Sys.sleep(0.5)
expect_true(app$get_js("HTMLWidgets.getInstance(document.getElementById('in_2')).hot.setDataAtCell(1,2,7);true;", timeout = 50L))
...
Sys.sleep(1)
expect_true(app$get_js("$('#inputDataTitle').text()==='default'", timeout = 2000L))
app$set_inputs(btImport = "click")
Sys.sleep(0.5)
