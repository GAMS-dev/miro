...
Sys.sleep(0.5)
app$findElement("a[data-value='Access permissions']")$click()
app$setInputs(editMetaReadPerm = c(getSelectizeOptions(app, "#editMetaReadPerm"), "_users"))
app$setInputs(editMetaWritePerm = c(getSelectizeOptions(app, "#editMetaWritePerm"), "_users"))
app$setInputs(editMetaExecPerm = c(getSelectizeOptions(app, "#editMetaExecPerm"), "_users"))
app$setInputs(btUpdateMeta = "click")
Sys.sleep(0.5)
app$setInputs(btSaveAs = "click")
Sys.sleep(0.5)
...
app2$setInputs(editMetaReadPerm = "_users")
app2$setInputs(btUpdateMeta = "click")
Sys.sleep(0.5)
...
Sys.sleep(2)
app2$setInputs(editMetaReadPerm = c(user1, "_users"), editMetaWritePerm = "_users")
app2$setInputs(btUpdateMeta = "click")
Sys.sleep(0.5)
expect_error(app2$findElement("#editMetaIncapOwner")$click(), NA)
Sys.sleep(2)
app2$setInputs(editMetaWritePerm = c(user1, "_users"), editMetaExecPerm = "_users")
app2$setInputs(btUpdateMeta = "click")
Sys.sleep(0.5)
expect_error(app2$findElement("#editMetaIncapOwner")$click(), NA)
Sys.sleep(2)
app2$setInputs(editMetaExecPerm = c(user1, "_users"))
app2$setInputs(btUpdateMeta = "click")
#allowed to save
app2$setInputs(btSave = "click")
Sys.sleep(0.5)
