...
app$wait_for_js("$('#editMetaExecPerm-label').is(':visible')===true", timeout = 5000L)
Sys.sleep(0.5)
...
Sys.sleep(1)
app$wait_for_js("$('.access-perm-spinner').is(':visible')===false", timeout = 5000L)
app$wait_for_js("$('#editMetaReadPerm-label').is(':visible')===true", timeout = 5000L)
Sys.sleep(0.5)
...
app2$wait_for_js("$('#editMetaReadPerm-label').is(':visible')===true", timeout = 5000L)
Sys.sleep(0.5)
...
Sys.sleep(1)
app2$wait_for_js("$('.access-perm-spinner').is(':visible')===false", timeout = 5000L)
app2$wait_for_js("$('#editMetaWritePerm-label').is(':visible')===true", timeout = 5000L)
Sys.sleep(0.5)
