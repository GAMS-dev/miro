...
if(identical(Sys.getenv("GMSMODELNAME"), "pickstock")){
  ...
  app$findElement("#cbSelectManuallyLoc")$click()
  app$setInputs(selInputDataLoc = c("maxstock", "price"))
  Sys.sleep(0.5)
  app$setInputs(btImportLocal = "click")
  app$setInputs(btOverwriteInput = "click")
  Sys.sleep(0.5)
  expect_true(app$waitFor("$('#symNotInDataSrc').is(':visible');", timeout = 50))
  app$waitFor("$('.modal-footer button[data-dismiss=\"modal\"]').click();true;", timeout = 50)
  Sys.sleep(0.5)
  app$findElement("#btRemove1")$click()
  Sys.sleep(0.5)
  app$findElement(".modal-footer .bt-gms-confirm")$click()
  ...
  app$setInputs(tb_importData = "tb_importData_local")
  app$uploadFile(localInput = paste0("../data/_scalars2.csv"))
  app$setInputs(cbSelectManuallyLoc = TRUE)
  app$setInputs(selInputDataLoc = c("maxstock", "_gmsopt_mip"))
  Sys.sleep(0.5)
  app$setInputs(btImportLocal = "click")
  app$setInputs(btOverwriteInput = "click")
  Sys.sleep(0.5)
  ...
  app$setInputs(inputTabset = paste0("inputTabset_", widgetSheetId))
  Sys.sleep(0.5)
  app$snapshot(items = list(input = c(paste0("slider_", c(widgetSheetId, widgetSheetId + 1L)), "dropdown_4")), 
               screenshot = TRUE)
}
app$stop()
