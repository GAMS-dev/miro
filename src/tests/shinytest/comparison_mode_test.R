...
Sys.sleep(3)
expect_error(app$wait_for_js("$('.tab-content div[data-value=\"contentScen_4_2\"]').is(':visible')", timeout = 50), NA)
app$click(selector = "a[data-value='contentScen_4_5']")
app$click(selector = "a[data-value='scen_5_']")
Sys.sleep(2)
expect_error(app$wait_for_js("$('.tab-content div[data-value=\"contentScen_5_5\"]').is(':visible')", timeout = 50), NA)
