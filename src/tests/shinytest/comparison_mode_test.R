...
Sys.sleep(1)
expect_true(app$waitFor("$('.tab-content div[data-value=\"contentScen_3_2\"]').is(':visible');", timeout = 2000))
...
Sys.sleep(1)
app$setInputs(exportFileType = "gdx", cbSelectManuallyExp = "true")
Sys.sleep(0.5)
app$setInputs(selDataToExport = c("_scalars_out", "dowvsindex"))
Sys.sleep(1)
