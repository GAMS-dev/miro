...
Sys.sleep(0.5)
app$setInputs(newLine_1 = paste0("_sys_metadata_", Sys.getenv("MIRO_MODEL_NAME"), "._stime"))
Sys.sleep(0.5)
app$setInputs(newLine_1 = paste0("_sys_metadata_", Sys.getenv("MIRO_MODEL_NAME"), "._uid"))
Sys.sleep(0.5)
app$setInputs(val_1_2 = Sys.info()[["user"]])
Sys.sleep(0.5)
app$setInputs(newLine_1 = paste0("_sys_metadata_", Sys.getenv("MIRO_MODEL_NAME"), "._stag"))
Sys.sleep(0.5)
...
Sys.sleep(1)
app$setInputs(btHcubeRemove = "click")
Sys.sleep(1)
app$setInputs(btHcubeRemove = "click")
Sys.sleep(3)
...
app$setInputs(hcubeLoadAll = "click")
Sys.sleep(1)
app$findElement("#shiny-modal #btHcubeDownload")$click()
app$setInputs(selExportFiletype = "gdx")
expect_download_size(app, "btHcubeDownloadConfirm", "hcubeScenarios.zip")
Sys.sleep(3)
noScen <- app$findElements("[id^='DataTables_Table_'] tbody tr")
expect_identical(length(noScen), 3L)
app$setInputs(hcubeLoadAll = "click")
...
noScen <- app$findElements("[id^='DataTables_Table_'] tbody tr")
expect_identical(length(noScen), 3L)
app$setInputs(hcubeLoadResults_rows_selected = 1, allowInputNoBinding_ = TRUE)
...
app$findElement("#shiny-modal .btn-default")$click()
Sys.sleep(1)
app$setInputs(hcubeLoadResults_rows_selected = 2, allowInputNoBinding_ = TRUE)
app$setInputs(btShowHash = "click")
Sys.sleep(1)
expect_true(app$waitFor("$('#shiny-modal').is(':visible');", 50))
...
app$findElement("#shiny-modal .btn-default")$click()
Sys.sleep(1)
app$setInputs(hcubeLoadResults_rows_selected = 3, allowInputNoBinding_ = TRUE)
app$setInputs(btShowHash = "click")
Sys.sleep(1)
expect_true(app$waitFor("$('#shiny-modal').is(':visible');", 50))
