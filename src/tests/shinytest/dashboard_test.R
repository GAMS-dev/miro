...
app$click(selector = paste0("div[id='tab_1_2-", rendererName, "-error_ratio']"))
Sys.sleep(1)
expect_true(identical(app$get_js(paste0("$('#tab_1_2-", rendererName, "-pricemergeuserFilter_date')[0].multiple")), TRUE))
expect_true(identical(app$get_js(paste0("$('#tab_1_2-", rendererName, "-pricemergeuserFilter_uni-selectized')[0].multiple")), FALSE))
app$stop()
