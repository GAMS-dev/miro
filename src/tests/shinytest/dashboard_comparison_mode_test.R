...
expect_identical(app$get_js(paste0("$('#cmpCustom___dashboard_1-error_test')[0].innerText"), timeout = 2000), "ERROR TEST\n79.61")
expect_identical(app$get_js(paste0("$('#cmpCustom___dashboard_1-error_test .info-box-number').css('color')"), timeout = 2000), "rgb(61, 153, 112)")
expect_identical(app$get_js(paste0("$('#cmpCustom___dashboard_1-error_train')[0].innerText"), timeout = 2000), "ERROR TRAIN\n$951.17$")
expect_identical(app$get_js(paste0("$('#cmpCustom___dashboard_1-error_train .info-box-number').css('color')"), timeout = 2000), "rgb(221, 75, 57)")
expect_identical(app$get_js(paste0("$('#cmpCustom___dashboard_1-testnegative')[0].innerText"), timeout = 2000), "TESTNEGATIVE\n-1,001$")
expect_identical(app$get_js(paste0("$('#cmpCustom___dashboard_1-testnegative .info-box-number').css('color')"), timeout = 2000), "rgb(51, 51, 51)")
expect_identical(app$get_js(paste0("$('#cmpCustom___dashboard_1-testpositive')[0].innerText"), timeout = 2000), "TESTPOSITIVE\n+1,001$")
