...
Sys.sleep(1L)
app$wait_for_js("$('.hc-widget-group:visible').length>0", timeout = 10000L)
expect_true(app$get_js("$('#hcWidget_11-label').text()==='huuuuiii'"))
expect_options(getSelectizeOptions(app, "#hcWidget_11"), c("0", "1"))
app$stop()
