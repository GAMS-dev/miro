...
expect_true(app$get_js("$('#in_1-miroPivot-savedViewsDD li').eq(1).children('.dropdown-item').click();true;", timeout = 50))
Sys.sleep(1)
expect_true(app$get_js("$('#in_1-miroPivot-customError').is(':visible')", timeout = 50))
