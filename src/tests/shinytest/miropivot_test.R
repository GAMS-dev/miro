...
expect_identical(configuration$options$plugins$title$text, "test")
expect_identical(configuration$options$scales$x$title$text, "xxx")
expect_identical(configuration$options$scales$y$title$text, "yyy")
expect_identical(configuration$options$scales$y2$title$text, "zzz")
expect_identical(configuration$options$scales$x$grid$display, FALSE)
expect_identical(configuration$options$scales$y$grid$display, TRUE)
expect_identical(configuration$options$scales$y$min, 15L)
expect_identical(configuration$options$scales$y2$type, "logarithmic")
expect_identical(configuration$data$datasets[[2]]$label, "New-york")
expect_identical(configuration$data$datasets[[3]]$label, "Topeka")
expect_identical(configuration$options$elements$point$radius, 0L)
expect_identical(configuration$data$datasets[[2]]$pointRadius, 3L)
expect_identical(configuration$data$datasets[[2]]$type, "line")
expect_identical(configuration$data$datasets[[2]]$stepped, TRUE)
expect_identical(configuration$data$datasets[[2]]$stack, "2")
expect_identical(configuration$data$datasets[[2]]$borderDash, list(10L, 5L))
expect_identical(configuration$data$datasets[[2]]$borderWidth, 5L)
expect_identical(configuration$type, "bar")
expect_identical(configuration$type, "bar")
expect_identical(configuration$options$plugins$tooltip$bodyFont$size, 22L)
expect_identical(configuration$options$plugins$tooltip$titleFont$size, 22L)
expect_identical(configuration$options$plugins$legend$labels$font$size, 22L)
expect_identical(configuration$options$scales$x$ticks$font$size, 22L)
expect_identical(configuration$options$scales$x$title$font$size, 22L)
expect_identical(configuration$options$scales$y$ticks$font$size, 22L)
expect_identical(configuration$options$scales$y$title$font$size, 22L)
...
expect_identical(configuration$data$datasets[[1]]$stack, "stack2")
expect_identical(configuration$data$datasets[[2]]$stack, "stack1")
expect_identical(configuration$data$datasets[[3]]$stack, "stack2")
expect_identical(configuration$data$datasets[[4]]$stack, "stack1")
expect_identical(configuration$data$datasets[[5]]$stack, "stack0")
expect_identical(configuration$data$datasets[[6]]$stack, "stack0")
...
expect_identical(app$get_js(paste0("$('#tab_1_2-miroPivot-filter_Hdr')[0].multiple")), TRUE)
expect_identical(app$get_values()$input[["tab_1_2-miroPivot-filter_Hdr"]], "quantities")
expect_identical(app$get_js(paste0("$('#tab_1_2-miroPivot-filter_j')[0].multiple")), TRUE)
...
expect_identical(app$get_js(paste0("$('#tab_1_2-miroPivot-filter_Hdr')[0].multiple")), FALSE)
expect_identical(app$get_js(paste0("$('#tab_1_2-miroPivot-filter_j')[0].multiple")), FALSE)
expect_identical(app$get_values()$input[["tab_1_2-miroPivot-filter_Hdr"]], "quantities")
