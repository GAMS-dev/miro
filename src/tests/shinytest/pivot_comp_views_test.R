...
expect_identical(app$get_js("$('#tab_0_3-miroPivot-useCustomChartColors').length"), 1L)
expect_identical(app$get_js("$('#tab_0_3-miroPivot-advancedTitle').length"), 1L)
expect_identical(app$get_js("$('#tab_0_3-miroPivot-advancedxTitle').length"), 1L)
expect_identical(app$get_js("$('#tab_0_3-miroPivot-advancedyTitle').length"), 1L)
expect_identical(app$get_js("$('#tab_0_3-miroPivot-useLogScaleY').length"), 1L)
expect_identical(app$get_js("$('#tab_0_3-miroPivot-addMultiChartSeries').length"), 1L)
...
app$set_inputs(`tab_0_1-miroPivot-pivotRenderer` = "table")
Sys.sleep(1)
app$click(selector = "#tab_0_1-miroPivot-saveView")
Sys.sleep(1)
app$set_inputs("tab_0_1-miroPivot-newViewName" = "table with title")
app$set_inputs("tab_0_1-miroPivot-advancedTitle" = "This is a cool title")
expect_identical(app$get_js("$('#tab_0_1-miroPivot-useCustomChartColors').length"), 0L)
app$set_inputs("tab_0_1-miroPivot-saveViewConfirm" = "click")
Sys.sleep(1)
app$wait_for_js("$('#tab_0_1-miroPivot-pivotTable .dt-title').is(':visible')", timeout = 2000L)
expect_identical(app$get_js("$('#tab_0_1-miroPivot-pivotTable .dt-title').text()"), "This is a cool title")
app$click(selector = "#tab_0_1-miroPivot-toggleViewButton")
Sys.sleep(0.5)
expect_error(app$wait_for_js("$('#tab_0_1-miroPivot-savedViewsDD .miro-pivot-view-button').eq(0).click()", timeout = 50), NA)
Sys.sleep(1)
expect_identical(app$get_js("$('#tab_0_1-miroPivot-newViewName').val()"), "table with title")
app$set_inputs("tab_0_1-miroPivot-advancedTitle" = "")
app$set_inputs("tab_0_1-miroPivot-saveViewConfirm" = "click")
Sys.sleep(1)
expect_identical(app$get_js("$('#tab_0_1-miroPivot-pivotTable .dt-title').text()"), "")
app$stop()
