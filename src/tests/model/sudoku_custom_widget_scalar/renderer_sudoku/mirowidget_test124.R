mirowidget_test124Output <- function(id, height = NULL, options = NULL, path = NULL) {
  ns <- NS(id)
  return(tagList(
    textOutput(ns("i")),
    textOutput(ns("j")),
...
renderMirowidget_test124 <- function(input, output, session, data, options = NULL, path = NULL, rendererEnv = NULL, views = NULL, ...) {
