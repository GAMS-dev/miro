# version number
MIROVersion <- "2.12.9999"
APIVersion <- "1"
MIRORDate <- "Jul 24 2025"
...
aboutDialogText <- paste0(
  ...
  "Copyright (c) 2025 GAMS Software GmbH &lt;support@gams.com&gt;<br/>",
  "Copyright (c) 2025 GAMS Development Corp. &lt;support@gams.com&gt;<br/><br/>",
