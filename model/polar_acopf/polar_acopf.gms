...
$if set gmswebui $include polar_acopf_webui_in.gms
...
$elseif %ic% == 4 $batinclude '%MODELPATH%ic_polar%sep%dcopf_pv.gms' linelimits condensed verbose allon obj Plim timeperiod
$elseif %ic% == 5 $batinclude '%MODELPATH%ic_polar%sep%dcopf_v.gms' linelimits condensed verbose allon obj Plim timeperiod
$elseif %ic% == 6 $batinclude '%MODELPATH%ic_polar%sep%decoupled.gms' linelimits condensed verbose
$elseif %ic% == 7 $batinclude '%MODELPATH%ic_polar%sep%dcopf_pv_loss.gms' linelimits condensed verbose
$elseif %ic% == 8 $batinclude '%MODELPATH%ic_polar%sep%matpower.gms' linelimits condensed verbose
$elseif %ic% == 9 $batinclude '%MODELPATH%ic_polar%sep%given.gms' linelimits condensed verbose
...
execute 'gams %MODELPATH%save_solution.gms gdxcompress=1 --ac=1 --case=%case% --solution=temp_solution.gdx --savesol=%savesol% --out=%out% --timeperiod=%timeperiod% lo=3'
