...
$elseif %ic% == 4 $batinclude '%MODELPATH%ic_rect%sep%dcopf_pv.gms' linelimits condensed verbose allon obj timeperiod
$elseif %ic% == 5 $batinclude '%MODELPATH%ic_rect%sep%dcopf_v.gms' linelimits condensed verbose allon obj timeperiod
$elseif %ic% == 6 $batinclude '%MODELPATH%ic_rect%sep%decoupled.gms' linelimits allon condensed allon obj verbose
$elseif %ic% == 7 $batinclude '%MODELPATH%ic_rect%sep%dcopf_pv_loss ' linelimits allon condensed verbose
$elseif %ic% == 8 $batinclude '%MODELPATH%ic_rect%sep%matpower.gms' linelimits condensed verbose
