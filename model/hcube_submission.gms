* file to generate Hypercube job submission script.
* Input: generated Hypercube file
* Output: Hypercube submission script with isolated GAMS calls
...
* to the directory names of the Hypercube file

* path to Hypercube file 
$if not set bfdir $set bfdir "."
* path to the GAMS model and data corresponding to the Hypercube file
...
# string manipulation (Hypercube file)
