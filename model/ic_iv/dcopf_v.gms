...
$call 'gams "dcopf.gms" lp=%system.lp% qcp=%system.qcp% idir1="%MODELPATH%dcopf" idir2="%MODELPATH%" --genPmin=%genPmin% --allon=%allon% --linelimits=%linelimits% --case="%case%" --obj=%obj% gdx=dctemp.gdx lo=3 --timeperiod=%timeperiod% --verbose=%verbose%'
