...
$call gams "%MODELPATH%iv_acopf%sep%iv_acopf.gms" idir1=%MODELPATH%iv_acopf idir2=%MODELPATH% --genPmin=%genPmin% --allon=%allon% --linelimits=%linelimits% --case="%case%" --obj=%obj% gdx=iv_acopftemp.gdx lo=3 --timeperiod=%timeperiod% reslim=3600 nlp=ipopth --verbose=%verbose%
