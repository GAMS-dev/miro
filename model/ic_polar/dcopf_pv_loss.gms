...
$call gams "%MODELPATH%dcopf%system.dirsep%dcopf.gms" lp=%system.lp% qcp=%system.qcp% idir1=%MODELPATH%dcopf idir2=%MODELPATH% --Plim=%Plim% --allon=%allon% --limits=%limits% --case="%case%" --obj=%obj% --lineloss=1.055 gdx=dctemp.gdx lo=3 --timeperiod=%timeperiod% --verbose=%verbose%
