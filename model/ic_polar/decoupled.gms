...
$call gams "%MODELPATH%polar_decoupled%system.dirsep%polar_decoupled.gms" idir1=%MODELPATH%polar_decoupled idir2=%MODELPATH% --genPmin=%genPmin% --allon=%allon% --linelimits=%linelimits% --case="%case%" --obj=%obj% gdx=decoupledtemp.gdx lo=3 --timeperiod=%timeperiod% reslim=3600 nlp=ipopth --verbose=%verbose%
